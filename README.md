...
| `invoice_demo.html` | Invoice Template Demo — Template A (Client Fee), Template B (Service Rendered), Template C (Commission Payout) with toggle, payment, and verification simulation |
